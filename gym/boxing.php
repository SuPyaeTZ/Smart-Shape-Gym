...
<body>
 ...
 <section class="facility__container">
      <div class="facility__image">
        <img src="images/boxing1.jpg" alt="facility" />
      </div>
      <div class="facility__content">
        <h2 class="section__header">Boxing</h2>
        <p>
        Boxing is a combat sport where two individuals, usually wearing protective gear, 
        compete in a boxing ring by throwing punches at each other. 
        It's a discipline that emphasizes technique, strategy, and athleticism. 
        </p>
        <p>
        Boxing not only serves as a competitive sport but also as an effective form of 
        fitness training, focusing on punches, footwork, and head movement to enhance 
