...
<body>
 ...
 <section class="facility__container">
      <div class="facility__image">
        <img src="images/cardio2.jpg" alt="facility" />
      </div>
      <div class="facility__content">
        <h2 class="section__header">Cardio Class</h2>
        <p>
        Cardio, short for cardiovascular training, includes any exercises 
        like running, cycling, or dancing that elevate your heart rate and 
        enhance cardiorespiratory fitness. 
        </p>
        <p>
        Common cardio exercises include jogging, jumping jacks, stair climbing, 
        and high-intensity interval training. These can be performed at home or 
        in a gym setting. 
        </p>
        <p>
