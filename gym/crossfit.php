...
<body>
 ...
 <section class="facility__container">
      <div class="facility__image">
        <img src="images/Gym.jpg" alt="facility" />
      </div>
      <div class="facility__content">
        <h2 class="section__header">Crossfit Class</h2>
        <p>
        A CrossFit class is a high-intensity, one-hour group session led by a certified coach. 
        Each class typically involves a warm-up, a skill or strength workout, 
        a high-intensity workout, and a cool-down. 
        </p>
        <p>
        The specific exercises and movements vary depending on the gym and the coach, 
        but they often incorporate functional movements like squats, presses, pull-ups, and running.
        </p>
        <p>
