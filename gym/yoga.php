...
<body>
 ...
 <section class="facility__container">
      <div class="facility__image">
        <img src="images/yoga4.jpg" alt="facility" />
      </div>
      <div class="facility__content">
        <h2 class="section__header">Yoga Class</h2>
        <p>
        Yoga is a group of physical, mental, and spiritual practices that 
        originated in ancient India, aiming to control the body and mind. 
        </p>
        <p>
        Yoga enhances strength and flexibility, also helping in pain management 
