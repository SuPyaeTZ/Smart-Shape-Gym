...
<body>
 ...
 <section class="facility__container">
      <div class="facility__image">
        <img src="images/zumba2.jpeg" alt="facility" />
      </div>
      <div class="facility__content">
        <h2 class="section__header">Zumba Class</h2>
        <p>
        Zumba is a popular fitness program that combines Latin and international 
        music with dance moves to create a high-energy workout. 
        </p>
        <p>
        Zumba classes are offered at various fitness centers and dance studios, 
        typically featuring repetitive choreography that gradually increases in intensity.
        </p>
        <p>
